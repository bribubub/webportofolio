...
@section('content')
<section id="portfolio" class="section-container bg-gray-800 text-gray-200 rounded-lg m-4 p-8 shadow-2xl border border-gray-700">
    <div class="container mx-auto px-4 md:px-8 max-w-6xl">
        <h2 class="text-4xl md:text-5xl font-bold text-center mb-12 text-amber-400">My Recent Work</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <!-- Project 1 -->
            <div class="bg-gray-700 rounded-xl shadow-lg overflow-hidden border border-gray-600 hover:shadow-2xl hover:border-amber-500 transition duration-300 ease-in-out transform hover:-translate-y-2">
                <img src="https://placehold.co/600x400/334155/FBBF24?text=E-commerce+Platform" alt="E-commerce Platform Thumbnail" class="w-full h-64 object-cover object-center border-b border-gray-600">
                <div class="p-6">
                    <h3 class="text-2xl font-semibold mb-3 text-amber-300">E-commerce Platform</h3>
                    ...
                    <a href="#" class="text-amber-400 hover:text-amber-300 font-medium text-lg flex items-center group">
                        View Project
            ...
            <!-- Project 2 -->
            <div class="bg-gray-700 rounded-xl shadow-lg overflow-hidden border border-gray-600 hover:shadow-2xl hover:border-amber-500 transition duration-300 ease-in-out transform hover:-translate-y-2">
                <img src="https://placehold.co/600x400/334155/FBBF24?text=Task+Manager+App" alt="Task Management App Thumbnail" class="w-full h-64 object-cover object-center border-b border-gray-600">
                <div class="p-6">
                    <h3 class="text-2xl font-semibold mb-3 text-amber-300">Advanced Task Manager</h3>
                    <p class="text-gray-300 text-sm mb-4">
            ...
            <!-- Project 3 -->
            <div class="bg-gray-700 rounded-xl shadow-lg overflow-hidden border border-gray-600 hover:shadow-2xl hover:border-amber-500 transition duration-300 ease-in-out transform hover:-translate-y-2">
                <img src="https://placehold.co/600x400/334155/FBBF24?text=Personal+Blog+Platform" alt="Blog Platform Thumbnail" class="w-full h-64 object-cover object-center border-b border-gray-600">
                <div class="p-6">
                    <h3 class="text-2xl font-semibold mb-3 text-amber-300">Personal Blog Platform</h3>
                    <p class="text-gray-300 text-sm mb-4">
            ...
            <!-- Project 4 -->
            <div class="bg-gray-700 rounded-xl shadow-lg overflow-hidden border border-gray-600 hover:shadow-2xl hover:border-amber-500 transition duration-300 ease-in-out transform hover:-translate-y-2">
                <img src="https://placehold.co/600x400/334155/FBBF24?text=Social+Media+App" alt="Social Media Clone Thumbnail" class="w-full h-64 object-cover object-center border-b border-gray-600">
                <div class="p-6">
                    <h3 class="text-2xl font-semibold mb-3 text-amber-300">Social Media App Concept</h3>
                    <p class="text-gray-300 text-sm mb-4">
            ...
            <!-- Project 5 -->
            <div class="bg-gray-700 rounded-xl shadow-lg overflow-hidden border border-gray-600 hover:shadow-2xl hover:border-amber-500 transition duration-300 ease-in-out transform hover:-translate-y-2">
                <img src="https://placehold.co/600x400/334155/FBBF24?text=RESTful+API+Service" alt="RESTful API Service Thumbnail" class="w-full h-64 object-cover object-center border-b border-gray-600">
                <div class="p-6">
                    <h3 class="text-2xl font-semibold mb-3 text-amber-300">RESTful API Service</h3>
                    <p class="text-gray-300 text-sm mb-4">
            ...
            <!-- Project 6 -->
            <div class="bg-gray-700 rounded-xl shadow-lg overflow-hidden border border-gray-600 hover:shadow-2xl hover:border-amber-500 transition duration-300 ease-in-out transform hover:-translate-y-2">
                <img src="https://placehold.co/600x400/334155/FBBF24?text=Data+Visualization" alt="Data Visualization Thumbnail" class="w-full h-64 object-cover object-center border-b border-gray-600">
                <div class="p-6">
                    <h3 class="text-2xl font-semibold mb-3 text-amber-300">Interactive Data Visualization</h3>
                    <p class="text-gray-300 text-sm mb-4">
