...
@section('content')
<section id="resume" class="section-container bg-gray-800 text-gray-200 rounded-lg m-4 p-8 shadow-2xl border border-gray-700">
    <div class="container mx-auto text-center px-4 md:px-8 max-w-4xl">
        <h2 class="text-4xl md:text-5xl font-bold text-center mb-8 text-amber-400">My Resume</h2>
        ...
        <a href="[Link to your Resume PDF]" target="_blank" class="bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-4 px-10 rounded-full text-xl shadow-xl transform transition duration-300 hover:scale-105 inline-flex items-center focus:outline-none focus:ring-4 focus:ring-emerald-300 focus:ring-opacity-75">
        ...
        <div class="mt-16 text-gray-400 text-sm">
            <p>If you have any issues with the download or require a different format, please don't hesitate to <a href="{{ url('/contact') }}" class="text-amber-400 hover:underline">contact me</a>.</p>
        </div>
    </div>
</section>
@endsection
